...
const ENDPOINT = "/vision/person/detect";
...
export default function PersonDetection() {
  const canonical =
    typeof window !== "undefined" ? window.location.origin + "/vision/person-detection" : "";
  const title = useMemo(() => "Person Detection", []);

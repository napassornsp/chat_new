...
type PetClass = { label: string; confidence: number };
type PetResponse = {
...
const ENDPOINT = "/vision/pet/classify";
...
export default function PetClassification() {
  const canonical =
    typeof window !== "undefined" ? window.location.origin + "/vision/pet" : "";
  const title = useMemo(() => "Pet Classification", []);
  ...
  const [resp, setResp] = useState<PetResponse | null>(null);
    ...
    <div className="container py-6">
      ...
      <header className="flex items-center gap-3 mb-4">
        ...
        <div className="ml-auto">
          <Badge variant="secondary">Mode: Pet</Badge>
        </div>
      </header>
